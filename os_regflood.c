/***************************************************************************************/
/* Anope Module : os_regflood.c : v1.x                                                 */
...
/*
Note:	This module requires Anope stable branch svn rev 2931 or above
		Alternatively, you can just patch revs 2929 and 2931 onto the 1.8.4 release
*/
